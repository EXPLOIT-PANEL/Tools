...
request_permission() {
    local approved="n"
    while [ "$approved" != "NGENTOD" ]
    do
    
        echo "TOKEN ADA DIWHATSAPP COK"
        echo""
        echo -n "pengguna $username masukan token : "
...
echo""
echo -e "${green} ${bold}"
autoketik "PILIH MUSIK BIRA TIDAK BOSEN"
echo""
...
echo -e "${red} ${bold}EXPLOIT ☢ GALIRUS ☢ FOOCK STORE ☢ Mr.4Rex_503∅𒆜 "
echo -e "${yellow}╔═══════════════════════════════════════╗ ${clear}"
echo -e "${yellow}║ LOKASI  : $CITY, $COUNTRY"
echo -e "${yellow}║ IP KAMU : $IP"
echo -e "${yellow}║ WAKTU   : $WAKTU"
echo -e "${yellow}╚═══════════════════════════════════════╝"
sleep 2
echo -e "${green} ${bold} 
...
echo""
 ...
 autoketik "[2]. SPAM TOOLSV5 PRENIUM (PM GALIRUS)"
 ...
 autoketik "[9]. OPEN NOKOS DLL (FOOCK STORE)"
