...
while true; do
    ...
    echo""
    autoketik "[1] INSTALL BAHAN KALO BELOM"
    autoketik "[2] KALO SUDAH NEXT KE TOOLS"
...
# Melanjutkan ke bagian permintaan izin
# (Bagian yang tersisa dari skrip asli...)
