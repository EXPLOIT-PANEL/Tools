...
@is_option
def IP_Track():
    ip = input(f"{Wh}\n LACAK LOKASI PAKAI IP : {Gr}")  # INPUT IP ADDRESS
    print()
    print(f' {Wh}============= {Gr}WAJIB IP ADDRES FRESH / BIAR TEPAT{Wh}=============')
...
def phoneGW():
    User_phone = input(
        f"\n {Wh}ENTER NOMOR TARGET {Gr}Ex [+6281xxxxxxxxx] {Wh}: {Gr}")  # INPUT NUMBER PHONE
    ...
    print(f"\n {Wh}========== {Gr} INFORMASI LACAK PAKAI NO HANDPHONE {Wh}==========")
...
def showIP():
    ...
    print(f"\n {Wh}[{Gr} + {Wh}] IP MU KONTOL : {Gr}{Show_IP}")
    print(f"\n {Wh}==============================================")
...
options = [
    ...
    {
        'num': 3,
        'text': '[LACAK PAKAI NOMOR HANDPHONE] (ONLY +62)',
        'func': phoneGW
    },
    {
        'num': 4,
        'text': '(LACAK PAKAI USERNAME)',
        'func': TrackLu
    },
    {
        'num': 0,
...
def option():
  ...
  TEAM : TUKANG ATTACK
              ...
              {Wh}GUNAKAN KAPAN SAJA ANDA INGIN 😍
  """)
...
def run_banner():
    ...
    stderr.writelines(f"""{Wh}
         .-.
       .'   `.          {Wh}--------------------------------
       :g g   :         {Wh}| {Gr}TUKANG ATTACK {Wh}|
       : o    `.        {Wh}|       {Gr}@CODE BY Mr.4Rex_503∅      {Wh}|
      :         ``.     {Wh}--------------------------------
     :             `.
    :  :         .   `.
    :   :          ` . `.
